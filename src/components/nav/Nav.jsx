...
const IconList = () => {
  ...
  const iconList = [
    {id: 1, to: "/portfolio", con: icon.homeSharp },
    {id: 2, to: "/portfolio/about", con: icon.personSharp },
    {id: 3, to: "/portfolio/portfolio", con: icon.folderOpenSharp },
    {id: 4, to: "/portfolio/contact", con: icon.mailOpenSharp },
  ];
